...
class apb_virtual_16b_write_seq extends apb_virtual_base_seq;
  ...
  apb_master_sequence apb_master_16b_write_seq_h[NO_OF_MASTERS];

  //Variable: apb_slave_16b_write_seq_h
  //Instantiation of apb_master_16b_write_seq
  apb_slave_sequence apb_slave_16b_write_seq_h[TOTAL_SLAVES];
